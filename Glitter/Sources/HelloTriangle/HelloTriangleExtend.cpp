...
int HelloTriangleExtend::runHelloColoredTriangle() {
    ...
    std::cout << "Compile Shader::" << infoLog << std::endl;
    ...
    unsigned int VAO,VBO_VERT,VBO_COLOR;
    glGenVertexArrays(1, &VAO);
    ...
    unsigned int aColorLocation = glGetAttribLocation(shaderProgram, "aColor");
    glVertexAttribPointer(aColorLocation , 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
